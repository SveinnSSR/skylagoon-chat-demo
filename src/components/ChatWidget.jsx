        ...
        switch (data.type) {
            ...
            case 'chunk':
                ...
                setStreamFullText(prev => {
                    ...
                    // For streaming, check if this chunk completes a sentence
                    const lastChar = data.content.slice(-1);
                    if (lastChar === '.' || lastChar === '?' || lastChar === '!') {
                        // If we have a sentence completion, scroll
                        scrollToBottom(true);
                    }
                    
                    // Update typing messages for rendering
                    // For streaming, use the full text immediately instead of gradual word reveals
                    setTypingMessages(prev => ({
                        ...prev,
                        [botMessageId]: { 
                            text: newText,
