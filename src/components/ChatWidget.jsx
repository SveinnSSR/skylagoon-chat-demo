...
const ChatWidget = ({ webhookUrl = 'https://sky-lagoon-chat-2024.vercel.app/chat', apiKey, language = 'en', isEmbedded = false, baseUrl }) => {
            ...
            wsRef.current.onmessage = (event) => {
                try {
                    ...
                    switch (data.type) {
                        ...
                        case 'stream-chunk':
                            // ✨ HIDE TYPING INDICATOR on first chunk for responsive feel
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            setIsStreaming(false);
            setCurrentStreamMessage('');
            // Keep typing indicator for HTTP fallback
            ...
            <div style={{
                ...
                {!isMinimized && (
                    <div style={{
                        ...
                        {/* ✨ RESPONSIVE TYPING INDICATOR - Shows immediately, hides on first chunk */}
