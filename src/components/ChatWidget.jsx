...
const ChatWidget = ({ webhookUrl = 'https://sky-lagoon-chat-2024.vercel.app/chat', apiKey, language = 'en' }) => {
    ...
    return (
        <div style={{
            ...
            // This line ensures the chat doesn't go off the top of the screen
            ...
            overflow: 'hidden',
            // Change this line from "bottom right" to "bottom center"
            transformOrigin: 'bottom center',
            transition: 'all 0.45s cubic-bezier(0.34, 1.56, 0.64, 1)', // Spring-like easing
            ...
            {/* Chat area with container to prevent green flash */}
            {!isMinimized && (
                <div style={{
